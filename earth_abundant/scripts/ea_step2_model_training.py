...
FEATURES_FILE = EA_ROOT / "data" / "results" / "ea_gpr_features.csv"
MODEL_FILE    = EA_ROOT / "data" / "models" / "ea_gpr_model.pkl"
...
def run_validation():
    ...
    try:
        ...
        print("  Run ea_step1_feature_extraction.py first.")
        return
    ...
    import json
    metrics_file = EA_ROOT / "data" / "models" / "ea_cv_metrics.json"
