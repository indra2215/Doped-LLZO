"""
ea_step1_feature_extraction.py
══════════════════════════════════════════════════════════════════════════════
EARTH-ABUNDANT PIPELINE — Step 1: Feature Extraction
══════════════════════════════════════════════════════════════════════════════
...
def main():
    print("=" * 65)
    print("EA PIPELINE — Step 1: Feature Extraction")
    print("=" * 65)
    ...
    print(f"Successfully extracted compositional features for {len(df_out)} samples.")
